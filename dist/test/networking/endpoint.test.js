...
const endpoint_construct_1 = require("../../src/networking/endpoint-construct");
test('Create SSM Endpoints', () => {
    ...
    new endpoint_construct_1.EndpointConstruct(stack, 'Endpoints', {
        vpc: vpc.vpc
    });
